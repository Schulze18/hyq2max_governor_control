...
void updateCoMJacobian(Eigen::Matrix<double,12,1> *, Eigen::Matrix<double,3,3> *, Eigen::Matrix<double,3,3> *, Eigen::Matrix<double,3,3> *, Eigen::Matrix<double,3,3> *, Eigen::Matrix<double,3,12> *);
